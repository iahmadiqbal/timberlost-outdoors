    ...
    <div className="bg-gradient-to-br from-white to-amber-50/30 rounded-3xl shadow-2xl group cursor-pointer h-full border-2 border-amber-300 hover:border-orange-500 transition-all duration-500 overflow-hidden float-animation hover:shadow-orange-500/30 hover:-translate-y-2">
      ...
      <div className="p-8 relative">
        ...
        <div className="relative inline-block mb-6">
          <div className="absolute inset-0 bg-gradient-to-br from-amber-400 to-orange-500 rounded-2xl blur-xl opacity-60 group-hover:opacity-100 transition-all duration-500"></div>
          <div className="relative w-20 h-20 bg-gradient-to-br from-amber-500 via-orange-500 to-amber-600 rounded-2xl flex items-center justify-center transform group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 shadow-2xl icon-bounce">
